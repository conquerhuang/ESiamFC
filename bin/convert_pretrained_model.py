...
if __name__ == '__main__':
    ...
    # parser.add_argument('--mat_path', type=str, default="./SiamFC/models/2016-08-17.net.mat")
    parser.add_argument('--mat_path', type=str, default=r"D:\workspace\SiamTracker\SiamTrackers\SiamTrackers\SiamFC\SiamFC\models\2016-08-17.net.mat")
    args = parser.parse_args()

    params = convert(args.mat_path)
    print(params)
    # torch.save(params, "./models/siamfc_pretrained.pth")
    torch.save(params, r"D:\workspace\SiamTracker\SiamTrackers\SiamTrackers\SiamFC\SiamFC\models\siamfc_pretrained.pth")
